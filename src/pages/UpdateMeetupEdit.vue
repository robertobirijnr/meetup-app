              ...
              <div class="meetup-side-box">
                ...
                <div class="meetup-side-box-place m-b-sm">
                  ...
                  <div class="field">
                    ...
                    <input v-model="meetup.location" class="input"
                           type="text">
                  </div>
                </div>
...
export default {
    ...
    computed:{
        meetup(){
          const meetup = this.$store.state.meetups.meetupById
    ...
    methods:{
        ...mapActions(['fetchMeetupsDetail','updateMeetups','fetchCategories']),
        fetchMeetupByIdHandler(){
            this.fetchMeetupsDetail(this.meetupId)
            .then(meetup =>{
                if(this.meetupCreator._id !== this.authUser._id){
        ...
        setDate(date){
        this.meetup.startDate = moment(date).format('LLL')
      ...
      updatedMeetup(){
          this.updateMeetups(this.meetup)
          .then(()=>{
